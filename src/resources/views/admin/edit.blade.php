...
@section("content")
    <div class="container" style="max-width: 1200px; padding-top: 50px; padding-bottom: 100px;">
        ...
        <div class="editor-card">
            <h2 class="fw-bold mb-4">✏️ 記事を編集する</h2>
            ...
            <form action="{{ route('admin.contents.update', $content->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <textarea name="body" id="body" rows="25">{{ old('body', $content->body) }}</textarea>
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="tag" id="tag" value="{{ old('tag', $tags) }}">
                </div>

                <button type="submit" class="btn-update-save">🚀 更新内容を保存する</button>
            </form>
        </div>
    </div>
